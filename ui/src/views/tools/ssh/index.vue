  ...
  try {
    ...
    if (data?.config) {
      ...
      if (config.theme) {
        ...
        if (config.theme.selection) terminalSettings.selection = config.theme.selection;
      }
...
const handleSettingsUpdate = async (settings: any) => {
  ...
  if (settings.theme) {
    ...
    if (settings.theme.selection) terminalSettings.selection = settings.theme.selection;
  }
      ...
      data: {
        config: JSON.stringify({
          ...
          theme: {
            ...
            selection: terminalSettings.selection
          },
